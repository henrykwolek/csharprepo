...
namespace crypterSafety
{
    class Program
    {
        ...
        static void FileEncrypt(string inputFile, string password)
        {
            ...
            FileStream fsCrypt = new FileStream(inputFile + ".youAreAnIdiot", FileMode.Create);
        ...
        {
            string password = "Milenka";
            GCHandle gch = GCHandle.Alloc(password, GCHandleType.Pinned);
            FileEncrypt(@"H:\bc094dd\filmik.mp4", password);
